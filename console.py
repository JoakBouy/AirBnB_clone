...
def parse(arg):
    """Convert string to list of arguments"""
    return arg.split()

def check_args(argv, min_args=1):
    """Check if the number of arguments is at least min_args"""
    arg_list = parse(argv)
...
class HBNBCommand(cmd.Cmd):
    ...
    def do_all(self, arg):
        """Display string representations of all instances of a given class.If no class is specified, displays all instantiated objects."""
        argl = parse(arg)
